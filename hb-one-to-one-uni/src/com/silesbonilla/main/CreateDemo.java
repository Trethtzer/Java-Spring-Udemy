...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {			
			...
			Instructor tempInstructor = new Instructor("Pablo", "Alberca", "suspensosadomicilo@patucasa.com");
			InstructorDetail tempInstructorDetail = new InstructorDetail("http://algoalgo.com","playing vidfeogames");
